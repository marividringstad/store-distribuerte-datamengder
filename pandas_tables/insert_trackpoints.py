...
trackpoint_pandas = pd.read_csv("/Users/marividringstad/Desktop/Høst 2024/Store, distribuerte datamengder/store-distribuerte-datamengder/cleaned_tables/trackpoints_final.csv")
...
insert_trackpoints(trackpoint_pandas, batch_size=2000)